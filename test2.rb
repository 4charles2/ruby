class Personne
  ...
  def subit_attaque(degats_recus)
    ...
    # - Détermine si la personne est toujours en_vie ou non
      degats_recus = degats
      @points_de_vie = self.points_de_vie - degats_recus
      puts "#{nom} à subits des dégats il lui reste #{points_de_vie} HP"
...
class Joueur < Personne
  ...
  def soin
    ...
    # - Gagner de la vie
    # - Affiche ce qu'il s'est passé
      point_de_vie += rand(35..50)
      puts nom + " a récuperer des points de vie"
  end
  ...
  def ameliorer_degats
    ...
    # - Affiche ce qu'il s'est passé
      ...
      @degat_bonus = rand(30..60)
      puts nom + "a ameliorer son attaques de #{@degat_bonus} pour le prochain tours !"
  end
end
